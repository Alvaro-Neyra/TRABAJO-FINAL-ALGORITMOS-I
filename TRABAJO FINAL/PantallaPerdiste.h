...
namespace TRABAJOFINAL {
	...
	public ref class PantallaPerdiste : public System::Windows::Forms::Form
	{
	public:
		PantallaPerdiste(void)
		{
			InitializeComponent();
			juego = new Juego();
			FondoFinal = gcnew Bitmap("FondoFinal.jpg");
			BotonSalir = gcnew Bitmap("BotonSalir.png");
			ImagenGuardianDerrota = gcnew Bitmap("Derrota.png");

			timerPerdiste->Interval = 459;
			timerPerdiste->Tick += gcnew EventHandler(this, &PantallaPerdiste::MoverSprite);
			timerPerdiste->Start();

			this->pnlAnimacionDerrota->BackColor = Color::FromArgb(128, Color::Black);
...
#pragma region Windows Form Designer generated code
	private: System::Windows::Forms::Panel^ pnlAnimacionDerrota;
	...
	private: System::Windows::Forms::Label^ lblNivelMaximoAlcanzadoNumero;
		   ...
		   void InitializeComponent(void)
		   {
			   ...
			   this->pnlAnimacionDerrota = (gcnew System::Windows::Forms::Panel());
			   ...
			   // pnlAnimacionDerrota
			   // 
			   this->pnlAnimacionDerrota->Location = System::Drawing::Point(146, 369);
			   this->pnlAnimacionDerrota->Name = L"pnlAnimacionDerrota";
			   this->pnlAnimacionDerrota->Size = System::Drawing::Size(162, 193);
			   this->pnlAnimacionDerrota->TabIndex = 0;
			   this->pnlAnimacionDerrota->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &PantallaPerdiste::pnlAnimacionDerrota_Paint);
			   // 
			   // btnSalir
			   // 
			   ...
			   this->btnSalir->Click += gcnew System::EventHandler(this, &PantallaPerdiste::btnSalir_Click);
			   this->btnSalir->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &PantallaPerdiste::btnSalir_Paint);
			   // 
			   ...
			   this->lblPapelTotalRecogido->Size = System::Drawing::Size(183, 16);
			   this->lblPapelTotalRecogido->TabIndex = 8;
			   this->lblPapelTotalRecogido->Text = L"Residuos Totales Recogido: ";
			   // 
			   ...
			   this->lblNivelMaximoAlcanzado->Size = System::Drawing::Size(158, 16);
			   this->lblNivelMaximoAlcanzado->TabIndex = 10;
			   this->lblNivelMaximoAlcanzado->Text = L"Nivel Maximo Alcanzado:";
			   // 
			   ...
			   this->Controls->Add(this->pnlAnimacionDerrota);
			   this->FormBorderStyle = System::Windows::Forms::FormBorderStyle::None;
			   this->Name = L"PantallaPerdiste";
			   this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			   this->Text = L"PantallaPerdiste";
			   this->FormClosing += gcnew System::Windows::Forms::FormClosingEventHandler(this, &PantallaPerdiste::PantallaPerdiste_FormClosing);
			   this->Load += gcnew System::EventHandler(this, &PantallaPerdiste::PantallaPerdiste_Load);
			   this->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &PantallaPerdiste::PantallaPerdiste_Paint);
...
#pragma endregion
	...
	private:System::Void PantallaPerdiste_Paint(System::Object^ sender, System::Windows::Forms::PaintEventArgs^ e) {
	...
	private:System::Void pnlAnimacionDerrota_Paint(System::Object^ sender, System::Windows::Forms::PaintEventArgs^ e) {
		if (ImagenGuardianDerrota != nullptr) {
			int ancho = ImagenGuardianDerrota->Width / 6;
			int alto = ImagenGuardianDerrota->Height;

			Rectangle sPGuardian = Rectangle(guardianParte * ancho, 0, ancho, alto);

			Rectangle pIGuardian = Rectangle(0, 0, pnlAnimacionDerrota->Width, pnlAnimacionDerrota->Height);
	...
	private:System::Void MoverSprite(System::Object^ sender, System::EventArgs^ e) {
		guardianParte = (guardianParte + 1) % 6;

		pnlAnimacionDerrota->Invalidate();
	}
	...
	private: System::Void PantallaPerdiste_Load(System::Object^ sender, System::EventArgs^ e) {
		this->pnlAnimacionDerrota->Select();
	...
	private: System::Void PantallaPerdiste_FormClosing(System::Object^ sender, System::Windows::Forms::FormClosingEventArgs^ e) {

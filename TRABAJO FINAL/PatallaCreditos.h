...
namespace CppCLR_WinFormsProject1 {
	...
	/// <summary>
	/// Resumen de PatallaCreditos
	/// </summary>
	public ref class PatallaCreditos : public System::Windows::Forms::Form
	{
	public:
		PatallaCreditos(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
	...
	private: System::Windows::Forms::Button^ btnSalir;
		...
		void InitializeComponent(void)
		{
			...
			this->lblTitulo->Location = System::Drawing::Point(87, 135);
			this->lblTitulo->Name = L"lblTitulo";
			this->lblTitulo->Size = System::Drawing::Size(355, 95);
			...
			this->pnlPerfil1->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &PatallaCreditos::pnlPerfil1_Paint);
			// 
			// pnlPerfil2
			// 
			...
			this->pnlPerfil2->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &PatallaCreditos::pnlPerfil2_Paint);
			// 
			// pnlPerfil3
			// 
			...
			this->pnlPerfil3->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &PatallaCreditos::pnlPerfil3_Paint);
			// 
			// btnSalir
			// 
			...
			this->btnSalir->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 20, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->btnSalir->Location = System::Drawing::Point(12, 699);
			this->btnSalir->Name = L"btnSalir";
			this->btnSalir->Size = System::Drawing::Size(200, 50);
			this->btnSalir->TabIndex = 1;
			this->btnSalir->Text = L"S";
			this->btnSalir->UseVisualStyleBackColor = false;
			this->btnSalir->Click += gcnew System::EventHandler(this, &PatallaCreditos::btnSalir_Click);
			this->btnSalir->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &PatallaCreditos::btnSalir_Paint);
			// 
			// PatallaCreditos
			// 
			...
			this->Name = L"PatallaCreditos";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"PatallaCreditos";
			this->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &PatallaCreditos::PatallaCreditos_Paint);
...
private: System::Void PatallaCreditos_Paint(System::Object^ sender, System::Windows::Forms::PaintEventArgs^ e) {

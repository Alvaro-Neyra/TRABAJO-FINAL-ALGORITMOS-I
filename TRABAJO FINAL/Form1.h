...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->btnSalir->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &Form1::btnSalir_Paint);
			// 
			// btnIniciar
			// 
			...
			this->btnIniciar->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &Form1::btnIniciar_Paint);
			// 
			// btnCreditos
			// 
			...
			this->btnCreditos->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &Form1::btnCreditos_Paint);
			// 
			// btnHistoria
			// 
			...
			this->btnHistoria->Click += gcnew System::EventHandler(this, &Form1::btnHistoria_Click);
			this->btnHistoria->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &Form1::btnHistoria_Paint);
			// 
			// btnRankig
			// 
			...
			this->btnRankig->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &Form1::btnRankig_Paint);
			// 
			// Form1
			// 
...
#pragma endregion
	...
	private: System::Void btnIniciar_Click(System::Object^ sender, System::EventArgs^ e) {
		CppCLR_WinFormsProject1::PantallaNiveles^ pantallaNiveles = gcnew CppCLR_WinFormsProject1::PantallaNiveles();
	...
	private: System::Void btnCreditos_Click(System::Object^ sender, System::EventArgs^ e) {
		CppCLR_WinFormsProject1::PatallaCreditos^ PatallaCreditos = gcnew CppCLR_WinFormsProject1::PatallaCreditos();
		PatallaCreditos->ShowDialog();
	}
